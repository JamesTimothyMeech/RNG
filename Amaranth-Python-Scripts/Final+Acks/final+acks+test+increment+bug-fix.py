...
class PCG32(Elaboratable):
    ...
    def proc(self):
        for i in range(50):
            ...
            if i == 10:
                yield self.wb_bus.adr.eq(0x30000003)
                ...
                yield self.wb_bus.adr.eq(0x30000004)
                yield self.wb_bus.we.eq(1)
